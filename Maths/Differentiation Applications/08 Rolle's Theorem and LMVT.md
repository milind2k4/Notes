...
*There exists a point c in interval $(a,b)$ where the instantaneous rate change of the function is the same as the average value change of it over the entire interval.*
